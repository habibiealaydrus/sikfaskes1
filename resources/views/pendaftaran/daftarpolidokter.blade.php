                ...
                <div class="row mt-2 mb-2">
                    <section class="col-md-6">
                        <div class="card mx-3 my-3 px-3 py-3">
                            <div class="container ">
                                <h5>Konfirmasi Pendaftaran Poli Dokter</h5>
                                <form action="/tambahpasienpolidokter" method="post">
                                    @csrf
                                    <div class="form-group">
                                        <label>Nomor Medical Record </label>
                                        <input type="text" name="nomor_rekam_medik" class="form-control hide"
                                            id="nik" value="{{ $idpatient->nomor_rekam_medis }}">
                                    </div>
                                    <div class="form-group">
                                        <label>NIK</label>
                                        <input type="text" name="nik" class="form-control hide"
                                            id="nik" value="{{ $idpatient->nik }}">
                                    </div>
                                    <div class="form-group">
                                        <label>Nama</label>
                                        <input type="text" name="nama" class="form-control hide"
                                            id="nik" value="{{ $idpatient->nama }}">
                                    </div>
                                    <div class="form-group">
                                        <label>Tanggal Lahir</label>
                                        <input type="text" name="tanggal" class="form-control hide"
                                            id="nik"
                                            value="{{ date('d-m-Y', strtotime($idpatient->tanggal)) }}">
                                    </div>
                                    <p>Apakah pasien tersebut ingin didaftarkan ke Poli dokter?</p>
                                    <button type="submit" class="btn btn-primary"
                                        style="margin-bottom: 5%;">Daftarkan
                                    </button>
                                </form>
                                <a href="#"
                                    onclick="window.open('/cetakantrianpolidokter/{{ $idpatient->id }}', 'newwindow', 'width=400, height=250'); return false;"
