                        ...
                        <div class="col-md-12" style="padding: 1%;">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Edit User Baru</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                @foreach ($dataUser as $dataUserItem)
                                    <form action="/simpanedituser" method="POST">
                                        @csrf
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="role_id" id="role"
                                                    ...
                                                    <option>{{ $dataUserItem->user_level['name_level'] }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
